...
#Predefined spy
spy = Spy('Asif', 'Mr.', 24, 2.1,0)
#Predefined friends
friend_one = Spy('Baljinder', 'Mr.', 21, 2.7,0)
friend_two = Spy('Amritesh', 'Ms.', 18, 2.1,0)
friend_three = Spy('Kumar', 'Prof.', 33, 3.7,0)
friend_four = Spy('Akash','Mr.', 21, 2.2,0)
friend_five = Spy('Ashish','Mr.', 44, 4.4,0)
